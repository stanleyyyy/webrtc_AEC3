...
int main(int argc, char* argv[])
{
    ...
    while (current++ < total)
    {
        wav_read_data(h_ref, ref_tmp, bytes_per_frame_ref_in);
        wav_read_data(h_rec, aec_tmp, bytes_per_frame_rec_in);
        ...
        aec_frame.UpdateFrame(0, nullptr, sample_rate / 100, sample_rate, AudioFrame::kNormalSpeech, AudioFrame::kVadActive, rec_channels);
